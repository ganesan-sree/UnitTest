...
public class TestSurveyService {
	...
	public void testGetPercentageNotSureLoveKU() {
		...
		log.info("Percentage who love KU: " + notSurePercentage);
		assertEquals("Percentage who love KU is NOT 11, but should be.", 11, notSurePercentage);
	...
	public void testSaveAnswerValidAnswers() {
		...
		int notSurePercentage = surveyService.getPercentageNotSureLoveKU();
		log.info("Percentage who love KU: " + notSurePercentage);
		assertEquals("Percentage who love KU is NOT 12, but should be.", 12, notSurePercentage);
